...
#define PATH(name)                      "/home/manjot/.config/dwmblocks/myblocks/"name
...
/*      pathu                           pathc                           interval        signal */
        { PATH("cpu_gpu_temp.sh"),      NULL,                           2,              0},
        { PATH("net_bandwidth.sh"),     NULL,                           3,              0},
        { PATH("volume.sh"),            NULL,                           3,              0},
        { PATH("calendar.sh"),          NULL,                           30,             0},
